...
<section>
    ...
    {{ Form::open(array('url' => 'penjualan/store', 'method' => 'post')) }}
    @csrf
    <div class="card">
        <div class="card-header">
            <h2 class="my-auto font-weight-bold">Penjualan Baru</h2>
        </div>
        <div class="card-body">
            ...
            <div class="form-group">
                <h4 class="font-weight-bold mt-5">Data Penjualan</h4>
            </div>
            <div class="form-row">
                <div class="form-group col-md">
                        {!! Form::label('tgl_transaksi', 'Tanggal') !!}
                        <div class="form-row">
                            <div class="form-group col-md">{!! Form::text('tgl_transaksi', $tgl, ['class' => 'form-control text-center datepicker', 'required']) !!}</div>
                            <div class="form-group col-md">{!! Form::time('waktu_transaksi', $time, ['class' => 'form-control text-center', 'required']) !!}</div>
                        </div>
                </div>
                <div class="form-group col-md">
                    {!! Form::label('qty', 'Quantity') !!}
                    {!! Form::number('qty', '', ['id' => 'qty', 'class' => 'form-control text-center money', 'required']) !!}
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    {!! Form::label('total_modal', 'Total Modal') !!}
                    {!! Form::text('total_modal', '', ['id' => 'total_modal', 'class' => 'form-control text-center money', 'readonly']) !!}
                </div>
                <div class="form-group col-md-6">
                    {!! Form::label('total_harga', 'Total Harga Jual') !!}
                    {!! Form::text('total_harga', '', ['id' => 'total_harga', 'class' => 'form-control text-center money', 'required']) !!}
                </div>
            </div>
            <div class="form-group">
