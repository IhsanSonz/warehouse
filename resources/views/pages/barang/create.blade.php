...
<section>
    ...
    {{ Form::open(array('url' => 'barang/store', 'method' => 'post')) }}
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                {!! Form::text('nama', '', ['placeholder' => 'Robot', 'id' => 'nama', 'class' => 'form-control', 'required']) !!}
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-2">
                        ...
                        {!! Form::text('harga_modal', '', ['placeholder' => '12.500', 'id' => 'harga_modal', 'class' => 'form-control money', 'required']) !!}
                    </div>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-2">
                        ...
                        {!! Form::text('harga_jual', '', ['placeholder' => '15.000', 'id' => 'harga_jual', 'class' => 'form-control money', 'required']) !!}
                    </div>
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('deskripsi', 'Deskripsi') !!}
                {!! Form::textarea('deskripsi', '', ['id' => 'deskripsi', 'class' => 'form-control', 'rows' => 3, 'required']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('note', 'Note') !!}
                {!! Form::text('note', '', ['placeholder' => 'Optional', 'id' => 'note', 'class' => 'form-control', 'required']) !!}
            </div>
            <div class="form-group">
